...
type CreateRestaurant aggregates.Restaurant

type CreateRestaurantHandler interface {
	CreateRestaurant(ctx context.Context, command *CreateRestaurant) error
}
...
func (handle *createRestaurantImpl) CreateRestaurant(ctx context.Context, command *CreateRestaurant) error {
	if command == nil {
		return nil
	}
