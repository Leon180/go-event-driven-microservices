...
func (impl *SearchRestaurantsFullInfoImpl) SearchRestaurantsFullInfo(
	ctx context.Context,
	...
	if err := sql.Find(&restaurants).Error; err != nil {
		impl.contextLogger.WithContextInfo(ctx, enums.ContextKeyTraceID).
			Error("failed to search restaurants full info", err)
		return nil, err
	}
...
func (impl *SearchRestaurantsFullInfoImpl) applyTableAvailabilityFilter(
...
func (impl *ReadRestaurantsImpl) ReadRestaurantFullInfo(
	ctx context.Context,
	id string,
...
func (impl *UpdateRestaurantsImpl) UpdateRestaurant(
	ctx context.Context,
...
func (impl *UpdateRestaurantsImpl) UpdatePriceRange(
	ctx context.Context,
	updatePriceRange *entities.UpdatePriceRange,
) error {
...
func (impl *UpdateRestaurantsImpl) CreateBranchCategoryRelations(
	ctx context.Context,
	branchCategoryRelations entities.BranchCategoryRelations,
) error {
	...
	if err := impl.db.WithContext(ctx).Create(&branchCategoryRelations).Error; err != nil {
		impl.contextLogger.WithContextInfo(ctx, enums.ContextKeyTraceID).
			Error("failed to create branch category relations", err)
		return err
	}
	return nil
}

func (impl *UpdateRestaurantsImpl) UpdateBranchCategoryRelation(
	ctx context.Context,
	...
	if err := impl.db.WithContext(ctx).Model(&entities.BranchCategoryRelation{}).Where("id = ?", updateBranchCategoryRelation.ID).Updates(updateBranchCategoryRelation.ToUpdateMap()).Error; err != nil {
		impl.contextLogger.WithContextInfo(ctx, enums.ContextKeyTraceID).
			Error("failed to update branch category relation", err)
		return err
	}
	return nil
}
...
func (impl *UpdateRestaurantsImpl) DeleteBranchCategoryRelations(ctx context.Context, ids []string) error {
	...
	if err := impl.db.WithContext(ctx).Where("id IN (?)", ids).Delete(&entities.BranchCategoryRelation{}).Error; err != nil {
		impl.contextLogger.WithContextInfo(ctx, enums.ContextKeyTraceID).
			Error("failed to delete branch category relations", err)
		return err
	}
	return nil
}
...
func (impl *UpdateRestaurantsImpl) UpdateAvailable(
	ctx context.Context,
	updateAvailable *entities.UpdateAvailable,
) error {
...
func (impl *UpdateRestaurantsWithTransactionImpl) BeginTx(
	ctx context.Context,
) (repositories.UpdateRestaurantsWithTransaction, error) {
...
func (impl *UpdateRestaurantsTransactionImpl) CreateRestaurants(
	ctx context.Context,
...
func (impl *UpdateRestaurantsTransactionImpl) UpdateRestaurant(
	ctx context.Context,
	updateRestaurant *entities.UpdateRestaurant,
) error {
...
func (impl *UpdateRestaurantsTransactionImpl) UpdateBranch(
	ctx context.Context,
	updateBranch *entities.UpdateBranch,
) error {
...
func (impl *UpdateRestaurantsTransactionImpl) UpdateAddress(
	ctx context.Context,
	updateAddress *entities.UpdateAddress,
) error {
...
func (impl *UpdateRestaurantsTransactionImpl) CreatePriceRanges(
	ctx context.Context,
	priceRanges entities.PriceRanges,
) error {
	return NewUpdateRestaurants(impl.Db, impl.ContextLogger).CreatePriceRanges(ctx, priceRanges)
}

func (impl *UpdateRestaurantsTransactionImpl) UpdatePriceRange(
	ctx context.Context,
	updatePriceRange *entities.UpdatePriceRange,
) error {
...
func (impl *UpdateRestaurantsTransactionImpl) CreateBranchCategoryRelations(
	ctx context.Context,
	branchCategoryRelations entities.BranchCategoryRelations,
) error {
...
func (impl *UpdateRestaurantsTransactionImpl) UpdateBranchCategoryRelation(
	ctx context.Context,
	updateBranchCategoryRelation *entities.UpdateBranchCategoryRelation,
) error {
	return NewUpdateRestaurants(
		impl.Db,
		impl.ContextLogger,
	).UpdateBranchCategoryRelation(ctx, updateBranchCategoryRelation)
}
...
func (impl *UpdateRestaurantsTransactionImpl) UpdateTable(
	ctx context.Context,
	updateTable *entities.UpdateTable,
) error {
...
func (impl *UpdateRestaurantsTransactionImpl) CreateAvailables(
	ctx context.Context,
	availables entities.Availables,
) error {
	return NewUpdateRestaurants(impl.Db, impl.ContextLogger).CreateAvailables(ctx, availables)
}

func (impl *UpdateRestaurantsTransactionImpl) UpdateAvailable(
	ctx context.Context,
	updateAvailable *entities.UpdateAvailable,
) error {
