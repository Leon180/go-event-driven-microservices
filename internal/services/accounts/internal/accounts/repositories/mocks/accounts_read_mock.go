...
func (m *MockReadAccountByMobileNumberAndAccountType) ReadAccountByMobileNumberAndAccountType(ctx context.Context, mobileNumber string, accountTypeCode enums.AccountTypeCode) (*entities.Account, error) {
	m.ctrl.T.Helper()
