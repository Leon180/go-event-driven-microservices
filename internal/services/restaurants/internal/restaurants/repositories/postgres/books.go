...
func (impl *SearchBooksFullInfoImpl) SearchBooksFullInfo(ctx context.Context, searchBooks *dtos.SearchBooks) (aggregates.Books, error) {
	if searchBooks == nil {
		return nil, nil
	}
...
func (impl *UpdateBooksWithTransactionImpl) BeginTx(ctx context.Context) (repositories.UpdateBooksWithTransaction, error) {
