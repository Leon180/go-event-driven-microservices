...
func NewDeadLetterRabbitMQConsumer(
	...
	return &deadLetterRabbitMQConsumer{
...
type deadLetterRabbitMQConsumer struct {
...
func (r *deadLetterRabbitMQConsumer) Start(ctx context.Context) error {
	if r.connection == nil {
...
func (r *deadLetterRabbitMQConsumer) Stop() error {
	defer func() {
...
func (r *deadLetterRabbitMQConsumer) BindHandler(handler ...consumer.ConsumerHandler) {
	r.rabbitmqConsumerConfig.Handlers = append(r.rabbitmqConsumerConfig.Handlers, handler...)
}

func (r *deadLetterRabbitMQConsumer) Name() string {
	return r.rabbitmqConsumerConfig.Name
}

func (r *deadLetterRabbitMQConsumer) handleReconnectionEvent(ctx context.Context) {
	go func() {
...
func (r *deadLetterRabbitMQConsumer) handleReceived(ctx context.Context, delivery amqp.Delivery) {
...
func (r *deadLetterRabbitMQConsumer) handle(
	ctx context.Context,
	customizeAck *func(),
	customizeNack *func(),
...
func (r *deadLetterRabbitMQConsumer) handleWithRetry(
	ctx context.Context,
...
func (r *deadLetterRabbitMQConsumer) createMessageConsumeContext(
...
func (r *deadLetterRabbitMQConsumer) deserializeData(
	body []byte,
	eventType string,
