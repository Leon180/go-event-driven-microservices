...
func TypeByNameAndImplementedInterface[TInterface any](typeName string) reflect.Type {
...
func TypesImplementedInterfaceWithFilterTypes[TInterface any](types []reflect.Type) []reflect.Type {
	// https://stackoverflow.com/questions/7132848/how-to-get-the-reflect-type-of-an-interface
	implementedInterface := GetGenericTypeByT[TInterface]()
...
func TypesImplementedInterface[TInterface any]() []reflect.Type {
	// https://stackoverflow.com/questions/7132848/how-to-get-the-reflect-type-of-an-interface
	implementedInterface := GetGenericTypeByT[TInterface]()
	var res []reflect.Type
	for _, t := range types {
...
func GetFullTypeName(input any) string {
	if input == nil {
		return ""
	}
...
func GetSnakeTypeName(input any) string {
	if input == nil {
		return ""
	}
...
func GetKebabTypeName(input any) string {
	if input == nil {
		return ""
	}
...
func GetNonePointerTypeName(input any) string {
	if input == nil {
		return ""
	}
...
func GetPackageName(value any) string {
...
func GetBaseType(value any) any {
...
func GetBaseReflectType(value any) reflect.Type {
	if reflect.ValueOf(value).Kind() == reflect.Pointer {
...
func InstanceByType(typ reflect.Type) any {
...
func InstanceByTypeName(name string) any {
	typ := TypeByName(name)
...
func InstancePointerByTypeName(name string) any {
	typ := TypeByName(name)
	if typ.Kind() == reflect.Ptr {
...
// If the type is a pointer type, it will return a pointer instance of the type and
// if the type is a struct type, it will return an empty struct
func InstanceByPackageName(pkgPath string, name string) any {
...
func ImplementedInterfaceT[T any](obj any) bool {
	// Get the interface type
	interfaceType := reflect.TypeOf((*T)(nil)).Elem()
