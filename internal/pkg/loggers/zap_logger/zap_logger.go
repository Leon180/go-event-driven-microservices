...
import (
	...
	loggersconfigs "github.com/Leon180/go-event-driven-microservices/internal/pkg/loggers/configs"
...
func NewZapLogger(
	...
	cfg, err := loggersconfigs.NewLoggerConfig(env)
	if err != nil {
...
func newLogger(cfg *loggersconfigs.Logger, env enums.Environment) (*zap.Logger, *zap.SugaredLogger) {
	if cfg == nil {
